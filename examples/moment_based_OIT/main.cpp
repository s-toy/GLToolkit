...
private:
	void __initShaders()
	{
		...
		m_pMBOITMergeColorShaderProgram->addShader("shaders/MBOIT_merge_color.vert", EShaderType::VERTEX_SHADER);
		...
		m_pWBOITMergeColorShaderProgram->addShader("shaders/WBOIT_merge_color.vert", EShaderType::VERTEX_SHADER);
