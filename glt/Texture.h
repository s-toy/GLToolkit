...
namespace glt
{
	...
	public:
		...
		void createEmpty(unsigned int vWidth, unsigned int vHeight, GLint vInternalFormat = GL_RGB32F, GLenum vFormat = GL_RGB, GLenum vType = GL_FLOAT, GLint vWrapMode = GL_CLAMP_TO_EDGE, GLint vFilterMode = GL_LINEAR, bool vGenerateMipMap = GL_FALSE);
